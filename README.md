...
2. Importa `database/schema.sql`. Si ya tienes una base creada antes de este cambio, aplica también `database/migrations/2026_06_24_add_third_party_editing.sql`, `database/migrations/2026_06_24_add_third_party_portal_users.sql` y `database/migrations/2026_06_25_add_report_branches.sql`.
